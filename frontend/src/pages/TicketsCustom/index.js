				...
				<Grid item xs={8} className={classes.messagesWrapper}>
					{ticketId ? (
						...
						<Paper square variant="outlined" className={classes.welcomeMsg}>
							<div>
								<center>
									{/* opacity 0.2 = logo como marca d'água discreta no placeholder
									    da tela de Atendimentos. Logo da barra superior mantém 100%. */}
									<img
										style={{ margin: "0 auto", width: "80%", opacity: 0.2 }}

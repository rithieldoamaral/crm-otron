...
const TicketsManagerTabs = () => {
  ...
  return (
    <Paper elevation={0} variant='outlined' className={classes.ticketsWrapper}>
          ...
          <Paper elevation={0} square className={classes.tabsHeader}>
            ...
            >
              ...
              <Tab
                ...
                classes={{ root: classes.tab }}
              />
              {/* Aba dedicada à Secretária IA — conversas de gestão do admin,
                  separadas dos atendimentos de cliente (ticket #22, 2026-06-28).
                  Restrita a admins: são conversas privilegiadas (financeiro, gestão). */}
              {user.profile === 'admin' && (
                <Tab
                  value={'secretary'}
                  icon={<HeadsetMicIcon />}
      ...
      {/* Painel da Secretária IA: lista os tickets com status="secretary".
          showAll={true} é necessário porque esses tickets não têm userId/queueId
          (não são atendimentos humanos) — sem isso o ListTicketsService os filtra.
          Restrito a admins (conversas privilegiadas de gestão). */}
      {user.profile === 'admin' && (
        <TabPanel value={tab} name='secretary' className={classes.ticketsWrapper}>
          <TicketsList
            status='secretary'
            showAll={true}
            selectedQueueIds={selectedQueueIds}
